/*
   ...
   Contains Gzipped JQuerry that can be provided to the connected browser and
   eliminate the need for an active internet connection.

   HTML pages used in the browser configuration pages
*/
