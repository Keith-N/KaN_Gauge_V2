...
void updateDisplay() {
  ...
  if (ptrData[0]->dataName != "None") {
    ...
    ptrData[0]->alert = sensorAlertCheck(ptrData[0]->minimum, ptrData[0]->maximum, ptrData[0]->scaledValue);
  ...
  if (ptrData[1]->dataName != "None") {
        //Check if value is outside of alert thresholds, then print the values
    ptrData[1]->alert = sensorAlertCheck(ptrData[1]->minimum, ptrData[1]->maximum, ptrData[1]->scaledValue);
  ...
  if (ptrData[2]->dataName != "None") {
    //Check if value is outside of alert thresholds, then print the values
    ptrData[2]->alert = sensorAlertCheck(ptrData[2]->minimum, ptrData[2]->maximum, ptrData[2]->scaledValue);
  ...
  if (ptrData[3]->dataName != "None") {
    //Check if value is outside of alert thresholds, then print the values
    ptrData[3]->alert = sensorAlertCheck(ptrData[3]->minimum, ptrData[3]->maximum, ptrData[3]->scaledValue);
  ...
  if (ptrData[4]->dataName != "None") {
        //Check if value is outside of alert thresholds, then print the values
    ptrData[4]->alert = sensorAlertCheck(ptrData[4]->minimum, ptrData[4]->maximum, ptrData[4]->scaledValue);
  ...
  if (ptrData[5]->dataName != "None") {
        //Check if value is outside of alert thresholds, then print the values
    ptrData[5]->alert = sensorAlertCheck(ptrData[5]->minimum, ptrData[5]->maximum, ptrData[5]->scaledValue);
...
void updateDisplay_Analog() {
  ...
  AnMeter.updateNeedle(ptrData[9]->scaledValue, 0, selectedColor[3], TFT_BLACK, selectedColor[0]);
      //Check if value is outside of alert thresholds, then print the values
    ptrData[9]->alert = sensorAlertCheck(ptrData[9]->minimum, ptrData[9]->maximum, ptrData[9]->scaledValue);
  ...
  if (ptrData[7]->dataName != "None") {
    //Check if value is outside of alert thresholds, then print the values
    ptrData[7]->alert = sensorAlertCheck(ptrData[7]->minimum, ptrData[7]->maximum, ptrData[7]->scaledValue);
  ...
  if (ptrData[8]->dataName != "None") {
    //Check if value is outside of alert thresholds, then print the values
    ptrData[8]->alert = sensorAlertCheck(ptrData[8]->minimum, ptrData[8]->maximum, ptrData[8]->scaledValue);
